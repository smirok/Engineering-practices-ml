...
from src.visualization import plot_2d, plot_roc_curve, draw_tree
...
def best_fit():
    ...
    for max_depth in [3, 5, 7]:
        for min_samples_leaf in [3, 5, 10, 25]:
            dtc = DecisionTreeClassifier(criterion='gini', max_depth=max_depth, min_samples_leaf=min_samples_leaf)
    ...
    bestclf = DecisionTreeClassifier(criterion='gini',
